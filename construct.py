...
Original file is located at
    https://colab.research.google.com/drive/1czwuJ2ToBxvgEI3tK9V1Cfd-hwmjHlxK
...
from baseline_conditions_IC_matched_RLAs import *
                ...
                if ls_random:
                    ...
                    for edgex in treex.edges:
                        if not edgex[0]==root:
                            ...
                            dep_depth_rand=find.dependency_depth(edgex)
                            #print(dep_distance_rand)
                            #print("\n")
                    ...
                    for edgey in tree.edges:
                        if not edgey[0]==0:
                            ...
                            results2 = open('IC_matched_RLAs.csv','a')
                            results2.write(str(lang)+"\t"+"real"+"\t"+str(sent_id)+"\t"+str(n)+"\t"+str(max_arity_real)+"\t"+str(avg_arity_real)+"\t"+str(projection_degree_real)+"\t"+str(gap_degree_real)+"\t"+str(k_illnest_real)+"\t"+str(edgey)+"\t"+str(direction_real)+"\t"+str(dep_distance_real)+"\t"+str(dep_depth_real)+"\t"+str(projectivity_real)+"\t"+str(edge_degree_real)+"\t"+str(endpoint_cross_real)+"\t"+str(HDD_real)+"\n")
                            results2.close()
                    print("\n-----------------\n"+str(tree.edges))